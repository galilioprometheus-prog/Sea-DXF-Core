...
Quá trình phát triển đã hoàn tất đến checkpoint **M14.3dj**. Core hiện tại có
thể:
...
- kiểm tra và validate entity XDATA, gồm evidence APPID/LAYER chính xác ở nguồn
  ...
  application và capacity/coordinate/handle/payload-envelope theo từng entity, cùng kết quả staging thay thế handle
