...
Development is complete through checkpoint **M14.3dd**. The current core can:
...
- inspect and validate entity XDATA, including exact source and independently
  parsed destination APPID and LAYER evidence plus create-new, strictly reparsed,
  same-dialect staged group-1005 handle-replacement writes;
