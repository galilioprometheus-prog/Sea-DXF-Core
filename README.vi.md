...
Quá trình phát triển đã hoàn tất đến checkpoint **M14.3db**. Core hiện tại có
thể:
...
- kiểm tra và validate entity XDATA, gồm ghi kết quả staging thay thế handle
  group-1005 cùng dialect sang path mới rồi strict reparse để xác minh;
