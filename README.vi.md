...
Quá trình phát triển đã hoàn tất đến checkpoint **M14.3dl**. Core hiện tại có
thể:
...
- kiểm tra và validate entity XDATA, gồm evidence APPID/LAYER chính xác ở nguồn
  ...
  application, capacity/coordinate/handle/payload-envelope theo từng entity, projection giá trị logic và canonical group encoding ở đích, cùng kết quả staging thay thế handle
