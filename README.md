...
Development is complete through checkpoint **M14.3dk**. The current core can:
...
- inspect and validate entity XDATA, including exact source and independently
  ...
  per-entity capacity/coordinate/handle/payload-envelope readiness and per-value logical destination projection, plus create-new, strictly reparsed, same-
