...
Development is complete through checkpoint **M14.3dl**. The current core can:
...
- inspect and validate entity XDATA, including exact source and independently
  ...
  per-entity capacity/coordinate/handle/payload-envelope readiness, per-value logical destination projection, and canonical destination group encoding, plus create-new, strictly reparsed, same-
