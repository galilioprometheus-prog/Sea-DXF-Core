...
Development is complete through checkpoint **M14.3dj**. The current core can:
...
- inspect and validate entity XDATA, including exact source and independently
  ...
  per-entity capacity/coordinate/handle/payload-envelope readiness, plus create-new, strictly reparsed, same-
