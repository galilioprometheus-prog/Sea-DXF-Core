...
Status: R0.1 master-plan reset is in progress. DXF Core 1.0 remains the only
active product implementation program, currently documented through checkpoint
