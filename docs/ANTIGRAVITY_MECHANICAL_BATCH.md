...
Checkpoint: `M14.3dr-M14.4ar-hatch-boundary-spline-edge-point-numerics`
Repository root: `D:\SeaCad\SeaCad`
Baseline: `028d726b7f04709927e0d6c8c8d419dc1eb49fcb`
Review target: annotated tag `m14.4ar-hatch-boundary-spline-edge-point-numerics`
Report: `D:\SeaCad\AntigravityReports\seacad-m14.3dr-m14.4ar-hatch-boundary-spline-edge-point-numerics-2026-08-10.yaml`
...
M14.3dr through M14.4ar so implementation does not pause between checkpoints.

## Authority, procedure, and writes

Mechanically verify M14.3dr-M14.4ar only. Codex/user retain architecture,
...
```text
HEAD == m14.4ar-hatch-boundary-spline-edge-point-numerics^{}
m14.4ar-hatch-boundary-spline-edge-point-numerics^1 == m14.4aq-hatch-boundary-spline-edge-point-cards^{}
m14.4aq-hatch-boundary-spline-edge-point-cards^1 == m14.4ap-hatch-boundary-spline-edge-point-tuples^{}
m14.4ap-hatch-boundary-spline-edge-point-tuples^1 == m14.4ao-hatch-boundary-spline-edge-sequences^{}
m14.4ao-hatch-boundary-spline-edge-sequences^1 == m14.4an-hatch-boundary-edge-payload-partition^{}
m14.4an-hatch-boundary-edge-payload-partition^1 == m14.4am-hatch-boundary-spline-edge-header-semantics^{}
m14.4am-hatch-boundary-spline-edge-header-semantics^1 == m14.4al-hatch-boundary-spline-edge-header-numerics^{}
m14.4al-hatch-boundary-spline-edge-header-numerics^1 == m14.4ak-hatch-boundary-spline-edge-header-cards^{}
m14.4ak-hatch-boundary-spline-edge-header-cards^1 == m14.4aj-hatch-boundary-elliptic-arc-edge-wcs-geometry^{}
m14.4aj-hatch-boundary-elliptic-arc-edge-wcs-geometry^1 == m14.4ai-hatch-boundary-elliptic-arc-edge-ocs-geometry^{}
...
dxf-struct-r1c-hatch-edge-card-core^1 == m14.4ae-hatch-boundary-circular-arc-edge-wcs-geometry^{}
...
all fifty-nine review tags are annotated tag objects
```
...
crates/seacad-dxf-core/src/hatch_boundary_edge_payload_partition.rs
...
crates/seacad-dxf-core/src/hatch_boundary_elliptic_arc_edge_wcs_geometry.rs
...
crates/seacad-dxf-core/src/hatch_boundary_spline_edge_header_card.rs
crates/seacad-dxf-core/src/hatch_boundary_spline_edge_header_numeric.rs
crates/seacad-dxf-core/src/hatch_boundary_spline_edge_header_semantic.rs
crates/seacad-dxf-core/src/hatch_boundary_spline_edge_point_card.rs
crates/seacad-dxf-core/src/hatch_boundary_spline_edge_point_numeric.rs
crates/seacad-dxf-core/src/hatch_boundary_spline_edge_point_tuple.rs
crates/seacad-dxf-core/src/hatch_boundary_spline_edge_sequence.rs
...
crates/seacad-dxf-core/tests/hatch_boundary_edge_payload_partition_tests.rs
...
crates/seacad-dxf-core/tests/hatch_boundary_elliptic_arc_edge_wcs_geometry_tests.rs
crates/seacad-dxf-core/tests/hatch_boundary_spline_edge_header_card_tests.rs
crates/seacad-dxf-core/tests/hatch_boundary_spline_edge_header_numeric_tests.rs
crates/seacad-dxf-core/tests/hatch_boundary_spline_edge_header_semantic_tests.rs
crates/seacad-dxf-core/tests/hatch_boundary_spline_edge_point_card_tests.rs
crates/seacad-dxf-core/tests/hatch_boundary_spline_edge_point_numeric_tests.rs
crates/seacad-dxf-core/tests/hatch_boundary_spline_edge_point_tuple_tests.rs
crates/seacad-dxf-core/tests/hatch_boundary_spline_edge_sequence_tests.rs
...
docs/audits/DXF_STRUCT_R1C_HATCH_EDGE_CARD_CORE.md
...
docs/audits/M14_4AJ_HATCH_BOUNDARY_ELLIPTIC_ARC_EDGE_WCS_GEOMETRY.md
docs/audits/M14_4AK_HATCH_BOUNDARY_SPLINE_EDGE_HEADER_CARDS.md
docs/audits/M14_4AL_HATCH_BOUNDARY_SPLINE_EDGE_HEADER_NUMERICS.md
docs/audits/M14_4AM_HATCH_BOUNDARY_SPLINE_EDGE_HEADER_SEMANTICS.md
docs/audits/M14_4AN_HATCH_BOUNDARY_EDGE_PAYLOAD_PARTITION.md
docs/audits/M14_4AO_HATCH_BOUNDARY_SPLINE_EDGE_SEQUENCES.md
docs/audits/M14_4AP_HATCH_BOUNDARY_SPLINE_EDGE_POINT_TUPLES.md
docs/audits/M14_4AQ_HATCH_BOUNDARY_SPLINE_EDGE_POINT_CARDS.md
docs/audits/M14_4AR_HATCH_BOUNDARY_SPLINE_EDGE_POINT_NUMERICS.md
docs/plans/dxf-core-1.0/DXF_ENTITY_COMPLETION_PLAN.md
docs/plans/dxf-core-1.0/IMPLEMENTATION_PLAN.md
```

Compare paths as sets and require exactly 179 changed paths.
...
| `docs/audits/DXF_STRUCT_R1C_HATCH_EDGE_CARD_CORE.md` | 45 | `6f93250935ff4e5a5c78346770f252fd89604747ff6d24099d5f3e924b47d981` |
...
| `docs/audits/M14_4AF_HATCH_BOUNDARY_ELLIPTIC_ARC_EDGE_CARDS.md` | 45 | `599393e9f7b355b8cb72f9ecce6eacc227582ff99b4291b5483d74dee07c306f` |
...
| `docs/audits/M14_4AG_HATCH_BOUNDARY_ELLIPTIC_ARC_EDGE_NUMERICS.md` | 50 | `f7ce17cb5211dfdafcea87b783848e0d9d603b6e25671318a86d6768dce35702` |
...
| `docs/audits/M14_4AJ_HATCH_BOUNDARY_ELLIPTIC_ARC_EDGE_WCS_GEOMETRY.md` | 59 | `15c4b45d43342ed7bc22911e7f5184a97acebbb890fef5189430531c17820b87` |
...
| `docs/audits/M14_4AK_HATCH_BOUNDARY_SPLINE_EDGE_HEADER_CARDS.md` | 49 | `0d57998bf4e082ed59a3de2f667f8bfe3f69dc4f1f9740d567cfb428373d0b83` |
...
| `docs/audits/M14_4AL_HATCH_BOUNDARY_SPLINE_EDGE_HEADER_NUMERICS.md` | 55 | `52346eac4c426b1473791e6acb8ec72f3d81741fdabfba3c16a69d53e5661cf1` |
...
| `docs/audits/M14_4AM_HATCH_BOUNDARY_SPLINE_EDGE_HEADER_SEMANTICS.md` | 57 | `d26ca14c24d9e3cb4017dda79dfed4be903d951483c5bdb5c9a60dc0057d5dc7` |
| `docs/audits/M14_4AN_HATCH_BOUNDARY_EDGE_PAYLOAD_PARTITION.md` | 58 | `679d87c4feedc14c62e2674212ee684e56904b2592a57d192ef5ad0694bada19` |
| `docs/audits/M14_4AO_HATCH_BOUNDARY_SPLINE_EDGE_SEQUENCES.md` | 60 | `aacef0392e39dd083b0e9d8a5c488b71e2ff46bedd55a39f4afd855d0cf59051` |
| `docs/audits/M14_4AP_HATCH_BOUNDARY_SPLINE_EDGE_POINT_TUPLES.md` | 59 | `582e042bf2277ed1d4ad3905c3cf3cc2032172bc0e04644332fa1d8960f4407d` |
| `docs/audits/M14_4AQ_HATCH_BOUNDARY_SPLINE_EDGE_POINT_CARDS.md` | 58 | `9795e5631fb57343e815d99b4ea14897497ff7919fe99cf37e71196fec362a3d` |
| `docs/audits/M14_4AR_HATCH_BOUNDARY_SPLINE_EDGE_POINT_NUMERICS.md` | 57 | `a9ab1f65b57784c6c78aa8ff23b14d5767c373efee2e598d23af7b03548c0899` |
...
Compute every line count and lowercase SHA-256 and require exactly 178 matching
...
cargo +1.97.1 test -p seacad-dxf-core --test hatch_boundary_edge_payload_partition_tests
...
cargo +1.97.1 test -p seacad-dxf-core --test hatch_boundary_elliptic_arc_edge_wcs_geometry_tests
cargo +1.97.1 test -p seacad-dxf-core --test hatch_boundary_spline_edge_header_card_tests
cargo +1.97.1 test -p seacad-dxf-core --test hatch_boundary_spline_edge_header_numeric_tests
cargo +1.97.1 test -p seacad-dxf-core --test hatch_boundary_spline_edge_header_semantic_tests
cargo +1.97.1 test -p seacad-dxf-core --test hatch_boundary_spline_edge_sequence_tests
cargo +1.97.1 test -p seacad-dxf-core --test hatch_boundary_spline_edge_point_tuple_tests
cargo +1.97.1 test -p seacad-dxf-core --test hatch_boundary_spline_edge_point_card_tests
cargo +1.97.1 test -p seacad-dxf-core --test hatch_boundary_spline_edge_point_numeric_tests
...
rg -n 'DxfHatchBoundaryEdge(CardState|MemberRange|Member|Card|CardDirectory)|from_document|PhantomData' crates/seacad-dxf-core/src/hatch_boundary_edge_card.rs crates/seacad-dxf-core/src/hatch_boundary_line_edge_card.rs crates/seacad-dxf-core/src/hatch_boundary_circular_arc_edge_card.rs crates/seacad-dxf-core/src/lib.rs docs/ARCHITECTURE.md docs/audits/DXF_STRUCT_R1C_HATCH_EDGE_CARD_CORE.md
$duplicateCardStorage = @(rg -n '^pub (enum DxfHatchBoundary(Line|CircularArc)EdgeCardState|struct DxfHatchBoundary(Line|CircularArc)Edge(MemberRange|Member|Card|CardDirectory))' crates/seacad-dxf-core/src/hatch_boundary_line_edge_card.rs crates/seacad-dxf-core/src/hatch_boundary_circular_arc_edge_card.rs)
if ($duplicateCardStorage.Count -ne 0) { $duplicateCardStorage; throw 'Family card storage remains duplicated.' }
...
rg -n 'DxfHatchBoundaryEllipticArcEdge(WcsGeometryDirectory|WcsGeometryEntry|WcsGeometryIssue|WcsSegment)|hatch_boundary_elliptic_arc_edge_wcs_geometry_directory|ElevationUnavailable|ExtrusionUnavailable|NonFiniteDerivedGeometry|major_axis_endpoint_relative_to_center|transform_vector|OcsBasis' crates/seacad-dxf-core/src/hatch_boundary_elliptic_arc_edge_geometry.rs crates/seacad-dxf-core/src/hatch_boundary_elliptic_arc_edge_wcs_geometry.rs crates/seacad-dxf-core/src/hatch_polyline_wcs_geometry.rs crates/seacad-dxf-core/tests/hatch_boundary_elliptic_arc_edge_wcs_geometry_tests.rs crates/seacad-dxf-core/src/lib.rs docs/audits/M14_4AJ_HATCH_BOUNDARY_ELLIPTIC_ARC_EDGE_WCS_GEOMETRY.md
rg -n 'DXF_HATCH_BOUNDARY_SPLINE_EDGE_HEADER_ROLES|DxfHatchBoundarySplineEdgeHeader(Card|CardDirectory|CardState|Member|MemberRange|Role)|hatch_boundary_spline_edge_header_card_directory|Degree|Rational|Periodic|KnotCount|ControlPointCount' crates/seacad-dxf-core/src/hatch_boundary_spline_edge_header_card.rs crates/seacad-dxf-core/tests/hatch_boundary_spline_edge_header_card_tests.rs crates/seacad-dxf-core/src/lib.rs docs/audits/M14_4AK_HATCH_BOUNDARY_SPLINE_EDGE_HEADER_CARDS.md
rg -n 'DxfHatchBoundarySplineEdgeHeaderNumeric(Components|Directory|Entry|I16Value|I32Value|Issue)|hatch_boundary_spline_edge_header_numeric_directory|MultipleValues|InvalidAsciiNumber|boundary_spline_(degree|rational|periodic|knot_count|control_point_count)|decode_raw_i(16|32)' crates/seacad-dxf-core/src/hatch_boundary_spline_edge_header_numeric.rs crates/seacad-dxf-core/tests/hatch_boundary_spline_edge_header_numeric_tests.rs crates/seacad-dxf-core/src/lib.rs docs/audits/M14_4AL_HATCH_BOUNDARY_SPLINE_EDGE_HEADER_NUMERICS.md
rg -n 'DxfHatchBoundarySplineEdgeHeader(Periodicity|Rationality|SemanticDirectory|SemanticEntry|SemanticI32Value|SemanticIssue|SemanticPeriodicityValue|SemanticRationalityValue|Semantics)|hatch_boundary_spline_edge_header_semantic_directory|MissingRequiredValue|RationalFlagOutOfDomain|PeriodicFlagOutOfDomain|NonRational|Rational|NonPeriodic|Periodic' crates/seacad-dxf-core/src/hatch_boundary_spline_edge_header_semantic.rs crates/seacad-dxf-core/tests/hatch_boundary_spline_edge_header_semantic_tests.rs crates/seacad-dxf-core/src/lib.rs docs/audits/M14_4AM_HATCH_BOUNDARY_SPLINE_EDGE_HEADER_SEMANTICS.md
rg -n 'DxfHatchBoundaryEdgePayloadPartition(Directory|Entry|Issue)?|hatch_boundary_edge_payload_partition_directory|edge_data_fields_for_edge|path_trailer_fields_for_edge|SourceBoundaryCountAbsent|SourceBoundaryReferenceBeforeCount|UnexpectedTrailerField' crates/seacad-dxf-core/src/hatch_boundary_edge_payload_partition.rs crates/seacad-dxf-core/tests/hatch_boundary_edge_payload_partition_tests.rs crates/seacad-dxf-core/src/lib.rs docs/audits/M14_4AN_HATCH_BOUNDARY_EDGE_PAYLOAD_PARTITION.md
rg -n 'DxfHatchBoundarySplineEdgeSequence(Directory|Entry|Issue|Partition|Phase)|hatch_boundary_spline_edge_sequence_directory|header_fields_for_edge|knot_fields_for_edge|control_point_fields_for_edge|fit_point_fields_for_edge|start_tangent_fields_for_edge|end_tangent_fields_for_edge|FitDataCountAbsent|DuplicateFitDataCount|FieldOutOfOrder|UnexpectedField' crates/seacad-dxf-core/src/hatch_boundary_spline_edge_sequence.rs crates/seacad-dxf-core/tests/hatch_boundary_spline_edge_sequence_tests.rs crates/seacad-dxf-core/src/lib.rs docs/audits/M14_4AO_HATCH_BOUNDARY_SPLINE_EDGE_SEQUENCES.md
rg -n 'DxfHatchBoundarySplineEdgePoint(Grouping|Kind|MemberRole|Orphan|Tuple|TupleDirectory|TupleEntry|TupleIssue|TupleMember)|hatch_boundary_spline_edge_point_tuple_directory|tuples_for_edge|orphans_for_edge|members_for_tuple|SequenceUnavailable' crates/seacad-dxf-core/src/hatch_boundary_spline_edge_point_tuple.rs crates/seacad-dxf-core/tests/hatch_boundary_spline_edge_point_tuple_tests.rs crates/seacad-dxf-core/src/lib.rs docs/audits/M14_4AP_HATCH_BOUNDARY_SPLINE_EDGE_POINT_TUPLES.md
rg -n 'DxfHatchBoundarySplineEdgePointCard(Directory|Member|State)?|hatch_boundary_spline_edge_point_card_directory|cards_for_tuple|cards_for_edge|card_for_role|members_for_card|tuple_for_card|Absent|Unique|Multiple' crates/seacad-dxf-core/src/hatch_boundary_spline_edge_point_card.rs crates/seacad-dxf-core/tests/hatch_boundary_spline_edge_point_card_tests.rs crates/seacad-dxf-core/src/lib.rs docs/audits/M14_4AQ_HATCH_BOUNDARY_SPLINE_EDGE_POINT_CARDS.md
rg -n 'DxfHatchBoundarySplineEdgePointNumeric(Components|Directory|Entry|Issue|Value)|hatch_boundary_spline_edge_point_numeric_directory|entry_for_tuple|entries_for_edge|MultipleValues|InvalidAsciiNumber|NonFiniteDouble|boundary_spline_(control|fit)_point' crates/seacad-dxf-core/src/hatch_boundary_spline_edge_point_numeric.rs crates/seacad-dxf-core/tests/hatch_boundary_spline_edge_point_numeric_tests.rs crates/seacad-dxf-core/src/lib.rs docs/audits/M14_4AR_HATCH_BOUNDARY_SPLINE_EDGE_POINT_NUMERICS.md
...
`hatch_boundary_elliptic_arc_edge_geometry_tests` and
`hatch_boundary_elliptic_arc_edge_wcs_geometry_tests` and
`hatch_boundary_spline_edge_header_card_tests` and
`hatch_boundary_spline_edge_header_numeric_tests` and
`hatch_boundary_spline_edge_header_semantic_tests` and
`hatch_boundary_edge_payload_partition_tests` and
`hatch_boundary_spline_edge_sequence_tests` and
`hatch_boundary_spline_edge_point_tuple_tests` and
`hatch_boundary_spline_edge_point_card_tests` and
`hatch_boundary_spline_edge_point_numeric_tests`; 4/4 and 4/4 for the two analytic SPLINE tests; 11/11,
...
applicability, CRUD/write, rendering, and completion remain open.
For DXF-STRUCT-R1c prove Line and CircularArc retain their exact public role
orders, group-code mappings, edge-type filters, document methods, and
family-specific aliases while all card/member/directory storage and collection
resides in `hatch_boundary_edge_card.rs`. Prove the role marker prevents
Line/CircularArc member, card, and directory interchange; Absent/Unique/Multiple
cardinality, duplicate member order, mismatch retention, source identity,
cancellation, bounds, compact traits, and redaction remain unchanged through
both complete downstream chains. Require the two card suites to remain 4/4
each, all ten Line/CircularArc card-through-WCS suites to remain 40/40, and the
workspace to remain exactly 1,213 tests. Confirm production adds 280 lines,
deletes 472, removes 192 net lines, and changes no dependency, fixture, schema,
release artifact, support claim, raw byte, provenance, numeric, semantic, or
geometry policy.
For M14.4af prove every EllipticArc edge receives exactly eight ordered cards
for groups 10/20/11/21/40/50/51/73 with the documented CenterX/CenterY,
relative MajorAxisEndpointX/MajorAxisEndpointY, MinorToMajorRatio, StartAngle,
EndAngle, and Counterclockwise roles. Prove independent Absent/Unique/Multiple
states, duplicate source order, count-mismatch retention, no value selection,
and no cards for Line, CircularArc, Spline, malformed/unsupported, empty, or
Polyline states. Require all nine ASCII/Binary dialect pairs, cancellation,
source identity, bounds, family role typing, compact traits, and redaction; the
focused suite must pass 4/4, all three card-family suites 12/12, and workspace
exactly 1,217 tests. Confirm production adds 97 lines and no numeric,
requiredness, vector/ratio/angle/direction semantic, OCS/WCS geometry,
applicability, CRUD/write, rendering, completion, dependency, fixture, schema,
release, corpus, CI, or protected-surface claim.
For M14.4ag prove one numeric entry per EllipticArc edge with seven finite
binary64 components plus one exact signed Int16 direction value; bit-exact
signed zero; exact `entity.hatch` field/raw provenance; independent Absent and
Multiple states without winner selection; malformed ASCII and non-finite
Binary typed issues; count-mismatch retention; no entries for Line,
CircularArc, Spline, invalid, empty, or Polyline states; all nine ASCII/Binary
dialect pairs; cancellation, identity, bounds, compact traits, and redaction.
Require the focused suite to pass 4/4, the EllipticArc card-to-numeric chain
8/8, and workspace exactly 1,221 tests. Confirm no requiredness, major-axis
vector or ratio domain, angle normalization, direction 0/1 domain, OCS/WCS
geometry, applicability, CRUD/write, rendering, completion, dependency,
fixture, schema, release, corpus, CI, or protected-surface claim.
For M14.4ah prove all eight EllipticArc values are required; absent values
become MissingRequiredValue without invented raw provenance; duplicate,
malformed ASCII, and non-finite Binary values retain their exact M14.4ag issue
and available raw provenance. Prove the two-component OCS major-axis vector
requires finite squared magnitude strictly greater than `1e-12`, with exact
unavailable-component, degenerate, and non-finite-derived-magnitude states;
minor/major ratio accepts exactly the inclusive `1e-6..=1.0` domain; direction
0 maps Clockwise, 1 maps Counterclockwise, and every other signed Int16 remains
DirectionFlagOutOfDomain with exact raw provenance. Prove start/end angles
remain exact DXF degrees without normalization; mismatch retention; no entries
for Line, CircularArc, Spline, invalid, empty, or Polyline states; all nine
ASCII/Binary dialect pairs; cancellation, identity, bounds, compact traits,
and redaction. Require the focused suite to pass 4/4, the EllipticArc
...
For M14.4aj prove every usable M14.4ai OCS segment is joined to the exact HATCH
subclass elevation and explicit/defaulted extrusion. Prove the shared arbitrary-
axis basis projects the center as a point with elevation and the relative major-
axis endpoint as a translation-free vector, publishing only finite WCS center,
major-axis vector, and normalized normal. The exact source ratio, unnormalized
start/end DXF degrees, direction, complete OCS geometry, and elevation/extrusion
receipts must remain available. Prove failure precedence is source geometry,
elevation, extrusion, then non-finite derived geometry; count-mismatch
retention; no entries for Line, CircularArc, Spline, invalid, empty, or
Polyline states; all nine ASCII/Binary dialect pairs; cancellation, identity,
bounds, compact traits, and redaction. Confirm no minor axis, endpoint, angle
wrapping, signed sweep, or trigonometric value is derived. Require the focused
suite to pass 4/4, the EllipticArc card-to-WCS chain 20/20, and the workspace
exactly 1,233 tests. Confirm production adds 347 lines and tests add 501 lines
with no dependency, fixture, schema, release, corpus, CI, protected-surface,
applicability, CRUD/write, rendering, or completion change.
For M14.4ak prove every Spline edge receives exactly five ordered fixed-header
cards for Degree group 94, Rational group 73, Periodic group 74, KnotCount
group 95, and ControlPointCount group 96. Prove independent
Absent/Unique/Multiple states, duplicate source order, count-mismatch
retention, no value selection, and no cards for Line, CircularArc,
EllipticArc, malformed/unsupported, empty, or Polyline states. Prove group 97
remains unclassified because a final-edge payload may retain the path-level
source-boundary-object count, and prove knot, control-point, weight, fit-point,
and tangent sequences remain raw and unpartitioned. Require all nine
ASCII/Binary dialect pairs, cancellation, source identity, bounds, family role
typing, compact traits, and redaction; the focused suite must pass 4/4, all
four card-family suites 16/16, and workspace exactly 1,237 tests. Confirm
production adds 90 lines and tests add 337 lines with no numeric, requiredness,
degree/count/flag domain, group-97, repeated-sequence, topology, OCS/WCS
geometry, applicability, CRUD/write, rendering, completion, dependency,
fixture, schema, release, corpus, CI, or protected-surface claim.
For M14.4al prove one numeric entry per Spline edge with exact signed Int32
Degree/KnotCount/ControlPointCount values from groups 94/95/96 and exact signed
Int16 Rational/Periodic values from groups 73/74. Prove exact `entity.hatch`
field/raw provenance; independent Absent and Multiple states without winner
selection; malformed ASCII typed issues; signed extremes and out-of-domain
values remain exact without requiredness, Boolean, degree, or non-negative
count enforcement. Prove count-mismatch retention; no entries for Line,
CircularArc, EllipticArc, invalid, empty, or Polyline states; all nine
ASCII/Binary dialect pairs; cancellation, identity, bounds, compact traits,
and redaction. Prove group 97 remains unclassified and knot, control-point,
weight, fit-point, and tangent sequences remain raw and unpartitioned. Require
the focused suite to pass 4/4, the Spline header card-to-numeric chain 8/8,
and workspace exactly 1,241 tests. Confirm production adds 378 lines and tests
add 335 lines with no domain, topology, OCS/WCS geometry, applicability,
CRUD/write, rendering, completion, dependency, fixture, schema, release,
corpus, CI, or protected-surface claim.
For M14.4am prove all five Spline-edge header values are required; absent
values become MissingRequiredValue without invented raw provenance, while
duplicate and malformed values retain their exact M14.4al issue and available
provenance. Prove Rational group 73 maps only 0 to NonRational and 1 to
Rational, Periodic group 74 maps only 0 to NonPeriodic and 1 to Periodic, and
all other signed Int16 values remain typed flag-domain failures. Prove exact
signed Int32 degree/knot-count/control-point-count values remain open without
an undocumented positive, non-negative, or degree-range constraint. Prove
count-mismatch retention; no entries for Line, CircularArc, EllipticArc,
invalid, empty, or Polyline states; all nine ASCII/Binary dialect pairs;
cancellation, identity, bounds, compact traits, and redaction. Prove group 97
remains unclassified and repeated knot/control-point/weight/fit/tangent
payloads remain raw. Require the focused suite to pass 4/4, the Spline header
card-to-semantic chain 12/12, and workspace exactly 1,245 tests. Confirm
production adds 391 lines and tests add 359 lines with no topology, OCS/WCS
geometry, applicability, CRUD/write, rendering, completion, dependency,
fixture, schema, release, corpus, CI, or protected-surface claim.
For M14.4an prove every grouped non-Polyline edge receives one source-stable
partition entry; every non-final edge retains its complete payload as edge data
with no path trailer; and the final edge selects the last group 97 as the outer
source-boundary-object count only when no group 330 precedes it and every
following field is group 330. Prove an earlier Spline group 97 plus fit points
and tangents remain exact edge data while the final group-97/330 suffix remains
an exact separate trailer. Prove missing outer counts, references before the
count, and non-330 suffix fields remain the three typed partition failures
without erasing lower edge/type evidence; mismatch retention; all nine
ASCII/Binary dialect pairs; cancellation, identity, bounds, compact traits,
and redaction. Require the focused suite to pass 4/4, the edge grouping-to-
partition chain 12/12, and workspace exactly 1,249 tests. Confirm production
adds 305 lines and tests add 341 lines with no source-count decoding,
cardinality, handle resolution, repeated Spline sequence grouping, topology,
geometry, applicability, CRUD/write, rendering, completion, dependency,
fixture, schema, release, corpus, CI, or protected-surface claim.
For M14.4ao prove every available Spline edge-data slice is partitioned into
the documented header, knot, control-point/weight, fit-data-count, fit-point,
start-tangent, and end-tangent phases while exact empty ranges remain explicit.
Prove non-Spline edges publish no sequence entry; header duplicates and
incomplete component sets remain raw for later cardinality/tuple work; and an
unavailable M14.4an partition retains its exact typed issue. Prove fit/tangent
fields before a fit-data count, duplicate fit-data counts, backward phase
transitions, and unrecognized fields remain four distinct typed failures
without erasing lower evidence; mismatch retention; all nine ASCII/Binary
dialect pairs; cancellation, identity, bounds, compact traits, and redaction.
Require the focused suite to pass 4/4, the edge grouping-to-sequence chain
16/16, and workspace exactly 1,253 tests. Confirm production adds 454 lines,
deletes one, and tests add 413 lines with no point tuple/cardinality, count
decoding/relation, weight default, numeric value, topology beyond phase order,
geometry, applicability, CRUD/write, rendering, completion, dependency,
fixture, schema, release, corpus, CI, or protected-surface claim.
For M14.4ap prove every available M14.4ao sequence groups group-10 control
points and group-11 fit points by same-kind X anchors while retaining every
following Y/weight member through the next anchor. Prove duplicate Y/weight
members and pre-anchor Y/weight orphans remain in exact source order, empty
control/fit phases publish explicit zero counts, and an unavailable sequence
retains its exact typed lower issue. Prove non-Spline edges publish no point
entry; count mismatch retains otherwise available tuples; all nine
ASCII/Binary dialect pairs; cancellation, identity, bounds, compact traits,
and redaction. Require the focused suite to pass 4/4, the edge grouping-to-
point-tuple chain 20/20, and workspace exactly 1,257 tests. Confirm production
adds 586 lines and tests add 524 lines with no numeric decoding, required-
component selection, weight default, header-to-observed count relation,
knot/tangent cardinality, topology, geometry, applicability, CRUD/write,
rendering, completion, dependency, fixture, schema, release, corpus, CI, or
protected-surface claim.
For M14.4aq prove every M14.4ap control-point tuple receives ordered Y and
Weight cards while every fit-point tuple receives only a Y card. Prove each
card independently reports Absent, Unique, or Multiple and retains every exact
matching lower tuple member in source order without selecting a winner. Prove
X anchors remain reachable through the retained tuple directory, available
empty sequences publish empty card slices, and unavailable sequences retain
their exact typed lower issue. Prove non-Spline edges publish no point-card
entry; count mismatch retains otherwise available cards; all nine ASCII/Binary
dialect pairs; cancellation, identity, bounds, compact traits, and redaction.
Require the focused suite to pass 4/4, the edge grouping-to-point-card chain
24/24, and workspace exactly 1,261 tests. Confirm production adds 267 lines and
tests add 450 lines with no numeric decoding, required-component selection,
weight default, header-to-observed count relation, knot/tangent cardinality,
topology, geometry, applicability, CRUD/write, rendering, completion,
dependency, fixture, schema, release, corpus, CI, or protected-surface claim.
For M14.4ar prove every M14.4ap tuple receives one source-stable numeric entry.
Prove its exact X anchor and every Unique Y/Weight card decode to finite
binary64 values with exact field/raw provenance and bit-preserved signed zero;
Absent and Multiple remain distinct; duplicates select no raw winner;
malformed ASCII and non-finite Binary values retain typed issues and available
raw provenance; and fit points publish no inapplicable Weight value. Prove
available empty sequences publish empty numeric slices, unavailable sequences
retain their exact lower issue, non-Spline edges publish no numeric entry, and
count mismatch retains otherwise usable entries. Require all nine ASCII/Binary
dialect pairs, cancellation, identity, bounds, compact traits, and redaction;
the focused suite must pass 4/4, the edge grouping-to-point-numeric chain
28/28, and workspace exactly 1,265 tests. Confirm production adds 361 lines and
tests add 453 lines with no required Y semantics, default weight, header-to-
observed count relation, knot/tangent cardinality, topology, geometry,
applicability, CRUD/write, rendering, completion, dependency, fixture, schema,
release, corpus, CI, or protected-surface claim.
Require zero production matches:

```powershell
rg -n 'panic!|unwrap\(|expect\(|todo!|unimplemented!|unsafe' crates/seacad-dxf-core/src/hatch_boundary_edge_card.rs
...
rg -n 'panic!|unwrap\(|expect\(|todo!|unimplemented!|unsafe' crates/seacad-dxf-core/src/hatch_boundary_elliptic_arc_edge_wcs_geometry.rs
rg -n 'panic!|unwrap\(|expect\(|todo!|unimplemented!|unsafe' crates/seacad-dxf-core/src/hatch_boundary_spline_edge_header_card.rs
rg -n 'panic!|unwrap\(|expect\(|todo!|unimplemented!|unsafe' crates/seacad-dxf-core/src/hatch_boundary_spline_edge_header_numeric.rs
rg -n 'panic!|unwrap\(|expect\(|todo!|unimplemented!|unsafe' crates/seacad-dxf-core/src/hatch_boundary_spline_edge_header_semantic.rs
rg -n 'panic!|unwrap\(|expect\(|todo!|unimplemented!|unsafe' crates/seacad-dxf-core/src/hatch_boundary_edge_payload_partition.rs
rg -n 'panic!|unwrap\(|expect\(|todo!|unimplemented!|unsafe' crates/seacad-dxf-core/src/hatch_boundary_spline_edge_sequence.rs
rg -n 'panic!|unwrap\(|expect\(|todo!|unimplemented!|unsafe' crates/seacad-dxf-core/src/hatch_boundary_spline_edge_point_tuple.rs
rg -n 'panic!|unwrap\(|expect\(|todo!|unimplemented!|unsafe' crates/seacad-dxf-core/src/hatch_boundary_spline_edge_point_card.rs
rg -n 'panic!|unwrap\(|expect\(|todo!|unimplemented!|unsafe' crates/seacad-dxf-core/src/hatch_boundary_spline_edge_point_numeric.rs
...
```powershell
git diff 028d726b7f04709927e0d6c8c8d419dc1eb49fcb..m14.4ar-hatch-boundary-spline-edge-point-numerics -- Cargo.toml Cargo.lock LICENSE NOTICE THIRD_PARTY_NOTICES.md schema corpus release .github .agents
git diff --check 028d726b7f04709927e0d6c8c8d419dc1eb49fcb..m14.4ar-hatch-boundary-spline-edge-point-numerics
```
...
if ($listed.Count -ne 1265) { throw 'Workspace test count drift.' }
git diff --check 028d726b7f04709927e0d6c8c8d419dc1eb49fcb..m14.4ar-hatch-boundary-spline-edge-point-numerics
```
...
all gates, exactly 1,265 tests, no mutation, and the
external report.

Write UTF-8 YAML-shaped evidence with batch id
`seacad-m14.3dr-m14.4ar-hatch-boundary-spline-edge-point-numerics-2026-08-10`, status/root/
