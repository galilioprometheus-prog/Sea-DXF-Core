...
Checkpoint: `M14.3dr-M14.3ea-spline-point-evaluation`
Repository root: `D:\SeaCad\SeaCad`
Baseline: `028d726b7f04709927e0d6c8c8d419dc1eb49fcb`
Review target: annotated tag `m14.3ea-spline-point-evaluation`
Report: `D:\SeaCad\AntigravityReports\seacad-m14.3dr-m14.3ea-spline-point-evaluation-2026-08-09.yaml`
...
M14.3dr through M14.3ea so implementation does not pause between checkpoints.

## Authority, procedure, and writes

Mechanically verify M14.3dr-M14.3ea only. Codex/user retain architecture,
...
```text
HEAD == m14.3ea-spline-point-evaluation^{}
...
all ten review tags are annotated tag objects
```
...
| Path | Lines | SHA-256 |
|---|---:|---|
| `README.md` | 184 | `5c5a0661617b7c49e68e0f6341ff9a18728ea14bd7ea8df1cb911e53278b875c` |
| `README.vi.md` | 182 | `b55bbb35d925116f7f6acb8f4e740953b29d9415ffe59f854c4047d983b3de59` |
...
| `crates/seacad-dxf-core/src/lib.rs` | 1,264 | `08feb99edad960a6c4f209cac29e56647f09f48ec2cb54131bb62f236681da77` |
...
| `crates/seacad-dxf-core/src/spline_point_evaluation.rs` | 339 | `285dc11692fd63671b886fe51155274830867c237417d2905048216443370784` |
...
| `docs/IMPLEMENTATION_PLAN.md` | 423 | `e0a5d61c9e4f9ac7759a015d0606ccf4f0ef2a4b2ce3e62ca9f52dab74224b74` |
| `docs/SUPPORT_MATRIX.md` | 2,956 | `925e5181032f90cdbb26b3c53038798b9dbf25e3a774368b31dd6e920c94d5ae` |
...
| `docs/plans/dxf-core-1.0/DXF_ENTITY_COMPLETION_PLAN.md` | 1,881 | `21324709690e43484b811a2475d9d9a70d3fa6b4c1d164eddce342536fa802e2` |
| `docs/plans/dxf-core-1.0/IMPLEMENTATION_PLAN.md` | 3,312 | `f82135cb6b984f0fa6432d44d4ca490e7b36220541f8a6fd5e8e76a0f2ab4fe4` |
...
Expected 6/6, 4/4, 11/11, 13/13, 18/18, 4/4, 3/3, 5/5, and 10/10. For M14.3dr prove create-new-only behavior,
...
added. Require zero production matches:

```powershell
rg -n 'panic!|unwrap\(|expect\(|todo!|unimplemented!|unsafe' crates/seacad-dxf-core/src/entity_completion.rs crates/seacad-dxf-core/src/entity_xdata_draft_write.rs crates/seacad-dxf-core/src/entity_xdata_encoded_destination.rs crates/seacad-dxf-core/src/point_clone_draft_projection.rs crates/seacad-dxf-core/src/point_clone_xdata_draft.rs crates/seacad-dxf-core/src/point_clone_xdata_insert.rs crates/seacad-dxf-core/src/entity_edit_session.rs crates/seacad-dxf-core/src/encoding.rs crates/seacad-dxf-core/src/spline_point_evaluation.rs crates/seacad-dxf-core/src/text_decoder.rs crates/seacad-dxf-core/src/text_encoder.rs crates/seacad-dxf-core/src/text_transcode.rs
```
...
```powershell
git diff 028d726b7f04709927e0d6c8c8d419dc1eb49fcb..m14.3ea-spline-point-evaluation -- Cargo.toml Cargo.lock LICENSE NOTICE THIRD_PARTY_NOTICES.md schema corpus release .github .agents
git diff --check 028d726b7f04709927e0d6c8c8d419dc1eb49fcb..m14.3ea-spline-point-evaluation
```
...
if ($listed.Count -ne 1083) { throw 'Workspace test count drift.' }
git diff --check 028d726b7f04709927e0d6c8c8d419dc1eb49fcb..m14.3ea-spline-point-evaluation
```
...
receipts, 6/6, 4/4, 11/11, 13/13, 18/18, 4/4, 3/3, 5/5, 10/10, all contract/
safety/link/protected checks, all gates, exactly 1,083 tests, no mutation, and the
external report.

Write UTF-8 YAML-shaped evidence with batch id
`seacad-m14.3dr-m14.3ea-spline-point-evaluation-2026-08-09`, status/root/
