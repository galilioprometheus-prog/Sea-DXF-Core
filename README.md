...
expansion is complete through M14.3bi. SeaCad opens bounded lossless ASCII
...
unreviewed ranges explicit; 15 Autodesk-sourced names now have reviewed ranges,
including ACAD_TABLE, HELIX, LIGHT, LWPOLYLINE, MESH, MLEADER, SECTIONOBJECT,
five surface specializations, and three underlays. None of this inventory
metadata implies semantic support.
