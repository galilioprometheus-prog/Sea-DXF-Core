...
Quá trình phát triển đã hoàn tất đến checkpoint **M14.3da**. Core hiện tại có
thể:
...
- kiểm tra và validate entity XDATA, gồm transaction thay thế handle group-1005
  cùng dialect đã được xác minh;
